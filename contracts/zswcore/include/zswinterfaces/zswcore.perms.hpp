...
#define ZSW_CORE_PERMS_TRANSFER_TOKEN_TO_ANYONE 1<<1
#define ZSW_CORE_PERMS_RECEIVE_TOKEN_FROM_ANYONE 1<<2
#define ZSW_CORE_PERMS_TRANSFER_TOKEN_TO_CORE_CONTRACTS 1<<3
#define ZSW_CORE_PERMS_RECEIVE_TOKEN_AS_CORE_CONTRACTS 1<<4
